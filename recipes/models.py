...
class Recipes(models.Model):
    ...
    cook_time_min = models.DecimalField(max_digits=3, decimal_places=0, blank=False, null=False, default=0)
    cook_time_max = models.DecimalField(max_digits=3, decimal_places=0, blank=False, null=False, default=0)
    prep_time = models.DecimalField(max_digits=3, decimal_places=0, blank=False, null=False, default=0)
...
class Ingredients(models.Model):
    ...
    amount = models.CharField(max_length=50, blank=False, null=False, default='')
